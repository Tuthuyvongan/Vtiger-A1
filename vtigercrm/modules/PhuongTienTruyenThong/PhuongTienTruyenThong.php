...
class PhuongTienTruyenThong extends Vtiger_CRMEntity {
    ...
    var $list_link_field = 'phuongtientruyenthong';
    ...
    var $popup_fields = Array ('phuongtientruyenthong');

    // For Alphabetical search
    var $def_basicsearch_col = 'phuongtientruyenthong';

    // Column value to use on detail view record text display
    var $def_detailview_recname = 'phuongtientruyenthong';

    // Used when enabling/disabling the mandatory fields for the module.
    // Refers to vtiger_field.fieldname values.
    var $mandatory_fields = Array('phuongtientruyenthong');

    var $default_order_by = 'phuongtientruyenthong';

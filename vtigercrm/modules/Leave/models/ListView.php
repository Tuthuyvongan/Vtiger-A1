 ...
 */
class Leave_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
        ...
        if(!$currentUserModel->isAdminUser() && $moduleName =='Leave' && !in_array($roleName, array('Vice President','HR','hR','Hr','hr'))){
            $listQuery .= ' AND vtiger_crmentity.smcreatorid ='.$currentUserModel->getId();

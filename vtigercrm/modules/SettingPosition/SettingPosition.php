...
class SettingPosition extends Vtiger_CRMEntity {
        var $table_name = 'vtiger_hrm_position';
        var $table_index= 'id';

        var $customFieldTable = Array('');

        var $tab_name = Array('vtiger_crmentity', 'vtiger_hrm_position');

        var $tab_name_index = Array(
                'vtiger_crmentity' => 'crmid',
                'vtiger_hrm_position' => 'id'
				);

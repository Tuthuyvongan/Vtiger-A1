 ...
 */
class Employee_ListView_Model extends Vtiger_ListView_Model {
    ...
    public function getListViewEntries($pagingModel) {
        ...
        if(!$currentUserModel->isAdminUser() && $moduleName =='Employee' && $roleName != 'Vice President'){
            $listQuery .= ' AND (vtiger_hrm_employee.user_id ='.$currentUserModel->getId();
            $listQuery .= ' OR vtiger_crmentity.smownerid ='.$currentUserModel->getId().' )';
        }
        ...
        if($moduleName=='Employee' && $_REQUEST['view']=='List'){
		$listQuery .= ' AND vtiger_user_id.`status` = "'.$status.'"';																 
        }elseif ($_REQUEST['src_module']=='Leave'){
    ...
    public function getListViewCount() {
		...
		if($status != ''){
            $listQuery .= ' AND vtiger_users.status = "'.$status.'"';
        }

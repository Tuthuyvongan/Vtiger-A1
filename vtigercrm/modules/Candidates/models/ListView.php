 ...
 */
class Candidates_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getListViewEntries($pagingModel) {
		...
		$pageLimit = $pagingModel->getPageLimit();
		 ...
		 if($status=='Potential'){
            $listQuery .= ' AND vtiger_hrm_candidate.`status` = "Potential"';
        }elseif($status=='Inactive'){
             $listQuery .= ' AND vtiger_hrm_candidate.`status` = "Inactive"';
         }else{
             $listQuery .= ' AND vtiger_hrm_candidate.`status` = "Failed"';
         }
	...
	public function getListViewCount() {
		...
		if($status != ''){
		    $listQuery .= ' AND vtiger_hrm_candidate.status ="'.$status.'"';
        }

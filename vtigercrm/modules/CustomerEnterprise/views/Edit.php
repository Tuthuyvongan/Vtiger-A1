...
class CustomerEnterprise_Edit_View extends Vtiger_Edit_View {
    protected $record = false;
    function __construct() {
        parent::__construct();
    }
    
    //Standard function from Vtiger
	...
	public function process(Vtiger_Request $request) {
	    ...
	    $field = $fieldList['makhachhang'];
	    $field->defaultvalue = CustomerEnterprise_Edit_View::generateMaKhachHang();
	...
	public function generateMaKhachHang()
	{
	    try {
	        ...
	        $query = "SELECT COUNT(*) FROM CustomerEnterprise;";
	        $records = vtws_query($query, $current_user);
	        $makhachhang = 'DN-'.$records[0][count];
	        return $makhachhang;

<?php /* Smarty version Smarty-3.1.7, created on 2020-06-09 09:21:44
         compiled from "E:\Software\XAMPP\htdocs\Project\Vtiger-A1\vtigercrm\includes\runtime/../../layouts/v7\modules\Inventory\partials\LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20718678835ec29a41334261-03943110%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9eed6ccffe1462d22b25420a9906721c6113a532' => 
    array (
      0 => 'E:\\Software\\XAMPP\\htdocs\\Project\\Vtiger-A1\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Inventory\\partials\\LineItemsEdit.tpl',
      1 => 1591694493,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20718678835ec29a41334261-03943110',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5ec29a418780c',
  'variables' => 
  array (
    'RECORD_STRUCTURE' => 0,
    'LINEITEM_FIELDS' => 0,
...
<?php if ($_valid && !is_callable('content_5ec29a418780c')) {function content_5ec29a418780c($_smarty_tpl) {?>
...
" /><input type="hidden" name="subtotal" id="subtotal" value="" /><input type="hidden" name="total" id="total" value="" /><div name='editContent' id='editContentItem'><?php $_smarty_tpl->tpl_vars['LINE_ITEM_BLOCK_LABEL'] = new Smarty_variable("LBL_ITEM_DETAILS", null, 0);?><?php $_smarty_tpl->tpl_vars['BLOCK_FIELDS'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value[$_smarty_tpl->tpl_vars['LINE_ITEM_BLOCK_LABEL']->value], null, 0);?><?php $_smarty_tpl->tpl_vars['BLOCK_LABEL'] = new Smarty_variable($_smarty_tpl->tpl_vars['LINE_ITEM_BLOCK_LABEL']->value, null, 0);?><?php if (count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)>0){?><div class='fieldBlockContainerItem'><div class="row"><div class="col-lg-5 col-md-5 col-sm-5"><div class="row"><div class="col-lg-4 col-md-4 col-sm-4"><h4 class='fieldBlockHeader' style="margin-top:5px;"><?php echo vtranslate($_smarty_tpl->tpl_vars['BLOCK_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button></div><?php }?></div></div><br><div class="fieldBlockContainerItem"><table class="table table-bordered blockContainer lineItemTable" id="lineItemResult"><tr><td width="83%"><div class="pull-right"><strong><?php echo vtranslate('LBL_ITEMS_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>

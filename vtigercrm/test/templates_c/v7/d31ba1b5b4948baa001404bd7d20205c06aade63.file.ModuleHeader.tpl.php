<?php /* Smarty version Smarty-3.1.7, created on 2020-05-25 03:53:23
         compiled from "D:\Software Official\xampp\htdocs\Project\Vtiger-A1\vtigercrm\includes\runtime/../../layouts/v7\modules\Employee\ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3701114285ecb4133c3e141-39041178%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd31ba1b5b4948baa001404bd7d20205c06aade63' => 
    array (
      0 => 'D:\\Software Official\\xampp\\htdocs\\Project\\Vtiger-A1\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Employee\\ModuleHeader.tpl',
      1 => 1587079614,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3701114285ecb4133c3e141-39041178',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ecb4133c95f8',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ecb4133c95f8')) {function content_5ecb4133c95f8($_smarty_tpl) {?>
...
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php }?><div align="center" id="license_notice" style="margin-top: 12px;padding-left: 77px;margin-left: 67px;"></div></div><div class="col-lg-5 col-md-5 pull-right"><div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php  $_smarty_tpl->tpl_vars['BASIC_ACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = false;
...
</a></li><?php } ?></ul></div></li><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Employee'&&$_REQUEST['view']=='List'){?><li><button id="syn_users" type="button" class="btn addButton btn-default module-buttons fa fa-user">Syn Users</button></li><?php }?></ul></div></div></div><?php if ($_smarty_tpl->tpl_vars['FIELDS_INFO']->value!=null){?><script type="text/javascript">var uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['FIELDS_INFO']->value;?>

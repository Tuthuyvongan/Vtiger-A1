<?php /* Smarty version Smarty-3.1.7, created on 2020-05-25 04:09:04
         compiled from "D:\Software Official\xampp\htdocs\Project\Vtiger-A1\vtigercrm\includes\runtime/../../layouts/v7\modules\Employee\partials\EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8773892855ecb44e0e2ef96-05020496%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc5424d7c84ca8e76ac2e848fc1ba4fcea184cd3' => 
    array (
      0 => 'D:\\Software Official\\xampp\\htdocs\\Project\\Vtiger-A1\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Employee\\partials\\EditViewContents.tpl',
      1 => 1587079614,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8773892855ecb44e0e2ef96-05020496',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ecb44e0e7356',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ecb44e0e7356')) {function content_5ecb44e0e7356($_smarty_tpl) {?>
...
' /><?php }?><input type="hidden" name="currentStatus" value="<?php echo $_smarty_tpl->tpl_vars['CURRENT_STATUS']->value;?>
"><div name='editContent'><?php if ($_smarty_tpl->tpl_vars['DUPLICATE_RECORDS']->value){?><div class="fieldBlockContainer duplicationMessageContainer"><div class="duplicationMessageHeader"><b><?php echo vtranslate('LBL_DUPLICATES_DETECTED',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</td><?php }?><?php }?><?php } ?><?php if ($_smarty_tpl->tpl_vars['RECORD_ID']->value&&$_smarty_tpl->tpl_vars['BLOCK_LABEL']->value=='LBL_PERSONAL_DETAIL'){?><tr><td class="fieldLabel alignMiddle">Status</td><td class="fieldValue"><select class="inputElement select2 select2-offscreen" name="employ_status" id="employStatus"><option value="">Select an option</option><option value="Active" <?php echo $_smarty_tpl->tpl_vars['ACTIVE_OP']->value;?>
>Active</option><option value="Inactive" <?php echo $_smarty_tpl->tpl_vars['INACTIVE_OP']->value;?>
>Inactive</option></select></td></tr><?php }?><?php if ((1 & $_smarty_tpl->tpl_vars['COUNTER']->value)){?><td></td><td></td><?php }?></tr></table></div><?php }?><?php } ?></div>

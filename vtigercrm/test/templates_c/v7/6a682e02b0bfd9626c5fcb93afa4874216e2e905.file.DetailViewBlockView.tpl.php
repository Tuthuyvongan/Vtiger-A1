<?php /* Smarty version Smarty-3.1.7, created on 2020-07-19 13:20:01
         compiled from "E:\Software\XAMPP\htdocs\Project\Vtiger-A1\vtigercrm\includes\runtime/../../layouts/v7\modules\JD\DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1449877525f1448818b7de0-95727573%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6a682e02b0bfd9626c5fcb93afa4874216e2e905' => 
    array (
      0 => 'E:\\Software\\XAMPP\\htdocs\\Project\\Vtiger-A1\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\JD\\DetailViewBlockView.tpl',
      1 => 1587079614,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1449877525f1448818b7de0-95727573',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f144881ba7f8',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f144881ba7f8')) {function content_5f144881ba7f8($_smarty_tpl) {?>
...
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><?php }?></tr></tbody></table></div></div><?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='JD'){?><div class="fieldBlockContainer"><h4 class="fieldBlockHeader" style="padding-left: 20px;">Tasks List</h4><hr><?php if (count($_smarty_tpl->tpl_vars['TASK_LIST']->value)>0){?><table  style="margin-left: 20px;" class="listview-table tasklisttbl"><tr style=" font-weight: bold;height:30px;border-bottom: 1px solid black;border-top: solid 1px black;"><td style="width: 3%;border: 1px solid black;">Task ID</td><td style="border: 1px solid black;">Task Description</td></tr><?php  $_smarty_tpl->tpl_vars['TASK_VALUE'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['TASK_VALUE']->_loop = false;
...
?><tr style="border-bottom: 1px solid black;border-top: solid 1px black;"><td style="border: 1px solid black;"><?php echo $_smarty_tpl->tpl_vars['TASK']->value;?>
</td><td style="border: 1px solid black;"><?php echo $_smarty_tpl->tpl_vars['TASK_VALUE']->value['task_description'];?>
</td></tr><?php } ?></table><?php }?></div><?php }?><br><?php } ?><?php }} ?>
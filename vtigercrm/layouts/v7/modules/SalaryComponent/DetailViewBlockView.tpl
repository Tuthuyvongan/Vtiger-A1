...
{strip}
	...
	{foreach key=BLOCK_LABEL_KEY item=FIELD_MODEL_LIST from=$RECORD_STRUCTURE}
        ...
        {if $MODULE eq 'SalaryComponent'}
			<div class="fieldBlockContainer">
				<h4 class="fieldBlockHeader" style="padding-left: 20px;">Salary Change</h4><hr>
        	{if count($SALARY_REF) gt 0}
				<table  style="margin-left: 20px;width: 40%;" class="listview-table tasklisttbl">
					<tr style=" font-weight: bold;height:30px;border-bottom: 1px solid black;border-top: solid 1px black;">
						...
						<td align="center" style="border: 1px solid black;">Experience</td>
						<td align="center" style="border: 1px solid black;width: 110px;">Salary</td >
						<td align="center" style="border: 1px solid black;width: 110px;">Qualification</td >
						<td align="center" style="border: 1px solid black;width: 110px;">Management Scale</td >
						<td align="center" style="border: 1px solid black;width: 142px;">Time To Review </br>(Months)</td>
						<td align="center" style="border: 1px solid black;width: 110px;">Level 1 </br>(2.6 -3)</td>
						<td align="center" style="border: 1px solid black;width: 110px;">Level 2 </br>(3.1 -3.6)</td>
						<td align="center" style="border: 1px solid black;width: 110px;">Level 3 </br>(> 3.6)</td>
					</tr>
                    {foreach from=$SALARY_REF key=TASK item=SALARY_VALUE}
						<tr style="border-bottom: 1px solid black;border-top: solid 1px black;">
							<td align="center" style="border: 1px solid black;">{$TASK}</td>
							<td align="center" style="border: 1px solid black;">{html_entity_decode($SALARY_VALUE.experience)}</td>
							<td align="center" style="border: 1px solid black;">{number_format($SALARY_VALUE.salary,0,'.',',')}</td>
							<td align="center" style="border: 1px solid black;">{$SALARY_VALUE.qualification}</td>
							<td align="center" style="border: 1px solid black;">{$SALARY_VALUE.management_scale}</td>
							<td align="center" style="border: 1px solid black;">{$SALARY_VALUE.time_to_review}</td>
							<td align="center" style="border: 1px solid black;">{$SALARY_VALUE.level1}</td>
							<td align="center" style="border: 1px solid black;">{$SALARY_VALUE.level2}</td>
							<td align="center" style="border: 1px solid black;">{$SALARY_VALUE.level3}</td>
						</tr>
                    {/foreach}
				</table>
        	{/if}

            ...
            <form class="form-horizontal recordEditView" id="QuickCreate" name="QuickCreate" method="post" action="index.php">
                ...
                <div class="modal-footer">
                    <center>
                        ...
                        <button class="btn btn-default" id="toFullForm" type="button"><a href="{$EDIT_VIEW_URL}" target="_blank"><strong>{vtranslate('LBL_GO_TO_FULL_FORM', $MODULE)}</strong></a></button>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        jQuery("#toFullForm").on('click',function () {

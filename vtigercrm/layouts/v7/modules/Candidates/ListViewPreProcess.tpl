    ...
    {if $MODULE eq 'Candidates'}
		<div class = "row" style="">
			...
			<div class='col-md-7' style="padding-top: 5px;text-align: center;">
				<div class="btn-group candidateFilter" style="text-align: center;">
					<button class="btn btn-default btn-primary" id="potentialCandidates" data-searchvalue="Potential">
						Potential
					</button>
					<button class="btn btn-default" id="inactiveCandidates" data-searchvalue="Inactive">
						Inactive
					</button>
					<button class="btn btn-default" id="failedCandidates" data-searchvalue="Failed">
						Failed
					</button>
				</div>
			</div>

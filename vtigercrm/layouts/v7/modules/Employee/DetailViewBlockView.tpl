...
{literal}
	<script type="text/javascript">
        jQuery(document).ready(function () {
			...
			jQuery("#Employee_detailView_fieldLabel_action").hide();
			jQuery("#Employee_detailView_fieldValue_action").hide();
			jQuery("#Employee_detailView_fieldLabel_flag").hide();
			jQuery("#Employee_detailView_fieldValue_flag").hide();
        });
	</script>
{/literal}
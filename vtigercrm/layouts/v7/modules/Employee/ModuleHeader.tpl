	...
	<div class="col-sm-12 col-xs-12 module-action-bar clearfix coloredBorderTop">
		<div class="module-action-content clearfix {$MODULE}-module-action-content">
			<div class="col-lg-7 col-md-7 module-breadcrumb module-breadcrumb-{$smarty.request.view} transitionsAllHalfSecond">
				...
				{/if}
				{*<div class="row" style="float: right;"><i id="license_notice" style="color: red;">{$LICENSE_MESSAGE}</i></div>*}
				<div align="center" id="license_notice" style="margin-top: 12px;padding-left: 77px;margin-left: 67px;"></div>
			</div>
			<div class="col-lg-5 col-md-5 pull-right">
				<div id="appnav" class="navbar-right">
					<ul class="nav navbar-nav">
						...
						{/if}
                        {if $MODULE eq 'Employee' && $smarty.request.view eq 'List'}
							<li>
								<button id="syn_users" type="button" class="btn addButton btn-default module-buttons fa fa-user">Syn Users</button>
							</li>
                        {/if}
					</ul>
				</div>
